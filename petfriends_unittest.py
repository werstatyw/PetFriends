...
class PetfriendsApplication(unittest.TestCase):
    def setUp(self):
    ...
    def test_petfriends_application(self):
        driver = self.driver
        ...
        driver.find_element_by_id("email").send_keys("isaid.zx@gmail.com")
        driver.find_element_by_id("pass").click()
        driver.find_element_by_id("pass").clear()
        driver.find_element_by_id("pass").send_keys("qwerty1234")
